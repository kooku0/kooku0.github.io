    ...
    elyg: function (t, e, r) {
      ...
      function A(t, e) {
        var r = !(arguments.length > 2 && void 0 !== arguments[2]) || arguments[2],
          n = t.pathname,
          o = (0, c.removePathTrailingSlash)((0, l.denormalizePagePath)(r ? E(n) : n));
        return (
          '/404' === o ||
            '/_error' === o ||
            (e.includes(o) ||
              e.some(function (e) {
                if ((0, p.isDynamicRoute)(e) && (0, g.getRouteRegex)(e).re.test(o))
        ...
        return (
          i(t, [
                          ...
                          switch ((e.prev = e.next)) {
                            ...
                            case 18:
                              if (
                                ...
                                (a = k(_(S(a) ? E(a) : a, i.locale, this.defaultLocale))),
                            ...
                            case 50:
                              if (
                                ((w = A(w, M)).pathname !== O &&
                                  ((O = w.pathname), (o = (0, h.formatWithValidation)(w))),
                                (O = O ? (0, c.removePathTrailingSlash)(E(O)) : O),
                            ...
                            case 62:
                              if (((U = x(E(U), this.locale)), !(0, p.isDynamicRoute)(N))) {
                                e.next = 78;
                                break;
                              }
                              if (
                                ((q = (0, d.parseRelativeUrl)(U)),
                                (W = q.pathname),
                                (F = (0, g.getRouteRegex)(N)),
                                (G = (0, m.getRouteMatcher)(F)(W)),
                                (H = (B = N === W) ? L(N, W, I) : {}),
                                G && (!B || H.result))
                              ) {
                                e.next = 77;
                              ...
                              if (
                                !(
                                  (V = Object.keys(F.groups).filter(function (t) {
                                    return !I[t];
                                  })).length > 0
                                )
                              ) {
                            ...
                            case 82:
                              ...
                              if (!(tt = J.pageProps.__N_REDIRECT).startsWith('/')) {
                                e.next = 93;
                                break;
                              }
                              if (
                                (A((et = (0, d.parseRelativeUrl)(tt)), M, !1),
                                !M.includes(et.pathname))
                              ) {
                                e.next = 93;
                                break;
                              }
                            ...
                            case 95:
                              if (((this.isPreview = !!J.__N_PREVIEW), J.notFound !== T)) {
                                e.next = 109;
                                break;
                              }
                              return (e.prev = 97), (e.next = 100), this.fetchComponent('/404');
                            case 100:
                              (at = '/404'), (e.next = 106);
                              break;
                            case 103:
                              (e.prev = 103), (e.t1 = e.catch(97)), (at = '/_error');
                            case 106:
                              return (
                                (e.next = 108), this.getRouteInfo(at, at, I, a, U, { shallow: !1 })
                              );
                            case 108:
                              K = e.sent;
                            case 109:
                            ...
                            case 116:
                              ...
                              throw (t.events.emit('routeChangeError', $, b, y), $);
                            case 119:
                              return (
                                t.events.emit('routeChangeComplete', a, y), e.abrupt('return', !0)
                              );
                            case 124:
                              if (((e.prev = 124), (e.t2 = e.catch(79)), !e.t2.cancelled)) {
                                e.next = 128;
                                break;
                              }
                      ...
                      function (e) {
                        for (;;)
                          switch ((e.prev = e.next)) {
                            ...
                            case 6:
                              if (
                                ((e.prev = 6), 'undefined' !== typeof l && 'undefined' !== typeof f)
                              ) {
                                e.next = 14;
                                break;
                              }
                              ...
                              return (
                                ...
                                this._getData(function () {
                                  return p
                                    ...
                                    : d
                                    ? m._getServerData(v)
                                    : m.getInitialProps(f, { pathname: r, query: o, asPath: a });
                                })
                              );
                            case 21:
                              return (
                            ...
                            case 15:
                              (p = t.sent),
                                ...
                                (v = (0, y.default)(
                                  ...
                                  a.query,
                                  function (t) {
                                    return A({ pathname: t }, u).pathname;
                                  },
                                  this.locales
                                )).matchedPage &&
                                  v.resolvedHref &&
                                    ...
                                    return (
                                      ...
                                      m._getStaticData(
                                        m.pageLoader.getDataHref(
                                          ...
                                          l,
                                          !0,
                                          'undefined' !== typeof o.locale ? o.locale : m.locale
                                        )
                                      )
                                    );
                                  }),
            ...
            },
            {
              ...
              value: function (t) {
                ...
                return !this.isPreview && this.sdc[r]
                  ...
                  : D(t, this.isSsr).then(function (t) {
                      return (e.sdc[r] = t), t;
                    });
              }
            },
            ...
            },
            {
              ...
              value: function (e, r) {
                this.clc &&
                  (t.events.emit('routeChangeError', w(), e, r), this.clc(), (this.clc = null));
              }
            },
            {
              key: 'notify',
        ...
        function k(t, r) {
          ...
          if (n === e) {
            if (((r.delegate = null), 'throw' === r.method)) {
              if (
                t.iterator.return &&
                ((r.method = 'return'), (r.arg = e), k(t, r), 'throw' === r.method)
              )
                return v;
              (r.method = 'throw'),
