  ...
  [6],
  {
                  ...
                  i !== document.title && (document.title = i),
                    ['meta', 'base', 'link', 'style', 'script'].forEach(function (e) {
                      !(function (e, t) {
                        ...
                        0;
                        for (
                          var o = Number(n.content), i = [], u = 0, c = n.previousElementSibling;
                          u < o;
      ...
      function a(e) {
        ...
        return (
          c
            ...
            : u && (a.textContent = 'string' === typeof u ? u : Array.isArray(u) ? u.join('') : ''),
          a
        );
      }
    ...
    IKlv: function (e, t, r) {
              ...
              },
              {
                ...
                value: function () {
                  this.scrollToHash(),
                    z.isSsr &&
                      (q ||
                        (N.nextExport && ((0, w.isDynamicRoute)(z.pathname) || location.search)) ||
              ...
              function (e) {
                for (;;)
                  switch ((e.prev = e.next)) {
                    ...
                    case 36:
                      return (
                        (t.router = z = (0, C.createRouter)(M, F, W, {
                          initialProps: R,
                          pageLoader: K,
                          App: Q,
                          Component: te,
                          ...
                          subscription: function (e, t, r) {
                            return oe(Object.assign({}, e, { App: t, scroll: r }));
                          },
                          locale: O,
                          locales: H,
                          defaultLocale: U,
                        ...
                        oe((c = { App: Q, initial: !0, Component: te, props: R, err: i })),
                        e.abrupt('return', ne)
                      );
                    case 44:
                      return e.abrupt('return', { emitter: ne, render: oe, renderCtx: c });
                    case 45:
                    case 'end':
                      return e.stop();
                  }
      ...
      function ue(e) {
        ...
        return (
          console.error(r),
          K.loadPage('/_error').then(function (n) {
            var a = n.page,
              o = n.styleSheets,
              i = me(t),
              u = {
                ...
                AppTree: i,
                router: z,
                ctx: { err: r, pathname: M, query: F, asPath: W, AppTree: i }
              };
            return Promise.resolve(e.props ? e.props : (0, x.loadGetInitialProps)(t, u)).then(
              function (t) {
                return he(
                  (0, m.default)({}, e, { err: r, Component: a, styleSheets: o, props: t })
                );
              }
            );
          })
      ...
      function de(e) {
        ...
        return h.default.createElement(
          ...
          h.default.createElement(
            ...
            { value: (0, C.makePublicRouterInstance)(z) },
      ...
      var pe,
        me = function (e) {
          return function (t) {
            var r = (0, m.default)({}, t, { Component: te, err: L, router: z });
            return h.default.createElement(de, null, h.default.createElement(e, r));
          };
        };
      function he(e) {
        var t = e.App,
                ...
                if (o && !c) {
                  for (
                    var t = new Set(
                      ...
                      r = k(document.querySelectorAll('style[data-n-href]')),
                      n = r.map(function (e) {
                  ...
                  (e.getCLS = function (e) {
                    ...
                    (e.getLCP = function (e) {
                      var t,
                        ...
                        u = function (e) {
                          var r = e.startTime;
                          r < i.timeStamp ? ((n.value = r), n.entries.push(e)) : (n.isFinal = !0),
                            t();
                        },
