      ...
      (function (t) {
        !(function () {
              ...
              if ((r = c ? o : f ? o[s] || k(s, {}) : (o[s] || {}).prototype))
                for (n in e) {
                  if (
                    ...
                    !Tt(c ? n : s + (f ? '.' : '#') + n, t.forced) && void 0 !== i)
                  ) {
          ...
          var Ue = { IteratorPrototype: Ee, BUGGY_SAFARI_ITERATORS: Le },
            ...
            De = function (t, e, r) {
              var n = e + ' Iterator';
              return (t.prototype = Ht(Fe, { next: f(1, r) })), Ne(t, n, !1), (Ce[n] = Be), t;
            },
            qe = function (t) {
              if (!y(t) && null !== t)
            ...
            Ye = function (t, e, r, n, o, i, a) {
              ...
              if (
                (g &&
                  ...
                  We !== Object.prototype &&
                    u.next &&
                    (Te(u) !== We && (ze ? ze(u, We) : 'function' != typeof u[Ge] && T(u, Ge, He)),
                    Ne(u, l, !0))),
                o == Ve &&
                  d &&
                  d.name !== Ve &&
                ...
                if (((s = { values: f(Ve), keys: i ? v : f($e), entries: f(Xe) }), a))
            ...
            Mr = r(function (t) {
              ...
              (t.exports = function (t, r, n, o, i) {
                ...
                for (l = a.next; !(h = l.call(a)).done; )
                  if ('object' == typeof (f = er(a, p, h.value, o)) && f && f instanceof e)
                    return f;
                return new e(!1);
              }).stop = function (t) {
                return new e(!0, t);
            ...
            $r = {
              getConstructor: function (t, e, r, n) {
                var o = t(function (t, i) {
                    Nr(t, o, e),
                      Kr(t, { type: e, index: Ht(null), first: void 0, last: void 0, size: 0 }),
                      a || (t.size = 0),
                      null != i && Mr(i, t[n], t, r);
                  }),
                  i = Gr(e),
            ...
            Lt(
              { target: 'Object', stat: !0, sham: !a },
              {
                getOwnPropertyDescriptors: function (t) {
                  for (var e, r, n = g(t), o = O.f, i = Et(n), a = {}, u = 0; i.length > u; )
                ...
                Br(s, {
                  delete: function (t) {
                    if (y(t) && !i(t)) {
                      var n = r(this);
                      return (
                        n.frozen || (n.frozen = new e()), c.call(this, t) || n.frozen.delete(t)
                      );
                    }
          ...
          var Ti = qt('species'),
            ...
            Ni = function (t, e, r, n) {
              ...
              if (!a || !u || ('replace' === t && (!ki || !Li || _i)) || ('split' === t && !Mi)) {
                var s = /./[o],
                  c = r(
                    o,
                    ''[t],
                ...
                [
                  ...
                  function (t, o) {
                    ...
                    for (var h = 0, p = 0, d = []; p < u.length; ) {
                      ...
                      if (null === g || (v = $i(ft(f.lastIndex + (Xi ? 0 : p)), u.length)) === h)
                        p = Fi(u, p, c);
                      else {
          ...
          var la = wt.f,
            ...
            Wa = function (t) {
              ...
              return (
                ...
                (!(r || !w(this, e) || !w(ka, e) || (w(this, ba) && this[ba][e])) || r)
              );
            },
            Ka = function (t, e) {
              var r = g(t),
              ...
              if (r !== Aa || !w(ka, n) || w(La, n)) {
                var o = ja(r, n);
                return !o || !w(ka, n) || (w(r, ba) && r[ba][n]) || (o.enumerable = !0), o;
              }
            },
            Ga = function (t) {
              var e = Ia(g(t)),
          ...
          if (
            ...
            Lt({ global: !0, wrap: !0, forced: !Nt, sham: !Nt }, { Symbol: Ra }),
            ma(zt(Ma), function (t) {
              ya(t);
            }),
            Lt(
            ...
            var Va =
              ...
              i(function () {
                var t = Ra();
                return '[null]' != Oa([t]) || '{}' != Oa({ a: t }) || '{}' != Oa(Object(t));
              });
            Lt(
                ...
                stringify: function (t, e, r) {
                  ...
                  if (((n = e), (y(e) || void 0 !== t) && !Da(t)))
                    return (
                      ne(e) ||
                        (e = function (t, e) {
                          if (('function' == typeof n && (e = n.call(this, t, e)), !Da(e)))
                            return e;
                        }),
                      (o[1] = e),
                      Oa.apply(null, o)
            ...
            var Ya = {},
              Ja = function () {
                var t =
                  ...
                  e = this instanceof Ja ? new Ha(t) : void 0 === t ? Ha() : Ha(t);
                return '' === t && (Ya[e] = !0), e;
              };
            xt(Ja, Ha);
          ...
          var Tu = gn.end,
            ...
            Lu = ku
              ...
              : ''.trimEnd;
          Lt({ target: 'String', proto: !0, forced: ku }, { trimEnd: Lu, trimRight: Lu }),
            re('String', 'trimRight');
          var Uu = qt('iterator'),
            _u = !i(function () {
                  ...
                  fetch: function (t) {
                    ...
                    return (
                      arguments.length > 1 &&
                        (y((e = arguments[1])) &&
                          fr((r = e.body)) === Yu &&
                          ((n = e.headers ? new Xu(e.headers) : new Xu()).has('content-type') ||
                            n.set(
                              'content-type',
                              'application/x-www-form-urlencoded;charset=UTF-8'
                            ),
                          (e = Ht(e, { body: f(0, String(r)), headers: f(0, n) }))),
                        o.push(e)),
                      Vu.apply(this, o)
                    );
                  }
          ...
          var gs,
            ...
            Ds = function (t, e) {
              ...
              if ('[' == e.charAt(0)) {
                ...
                for (r = '', n = pr(e), o = 0; o < n.length; o++) r += Xs(n[o], Ks);
                t.host = r;
              }
            },
            qs = function (t) {
              ...
              for (u = r.pop(), n = 0; n < r.length; n++) u += r[n] * Rs(256, 3 - n);
              return u;
            },
            zs = function (t) {
              var e,
            ...
            Hs = { ftp: 21, file: null, http: 80, https: 443, ws: 80, wss: 443 },
            Ys = function (t) {
                  ...
                  case oc:
                    if (i && (Ts.test(i) || '+' == i || '-' == i || '.' == i)) l += i.toLowerCase();
                      ...
                      if (
                        ...
                        return;
                      if (((t.scheme = l), r))
                        return void (Ys(t) && Hs[t.scheme] == t.port && (t.port = null));
                      (l = ''),
                        'file' == t.scheme
                          ? (c = gc)
                    ...
                    if (!ks.test(i)) {
                      if (
                        ...
                        if ('' != l) {
                          ...
                          (t.port = Ys(t) && m === Hs[t.scheme] ? null : m), (l = '');
                        }
                        if (r) return;
                        c = bc;
                        continue;
            ...
            (a &&
              Wt(Oc, {
                ...
                username: Bc(Tc, function (t) {
                  ...
                  if (!Qs(e)) {
                    e.username = '';
                    for (var n = 0; n < r.length; n++) e.username += Xs(r[n], Vs);
                  }
                }),
                password: Bc(kc, function (t) {
                  ...
                  if (!Qs(e)) {
                    e.password = '';
                    for (var n = 0; n < r.length; n++) e.password += Xs(r[n], Vs);
                  }
                }),
                      ...
                      Mr(t, function (t) {
                        ...
                        o.push(void 0),
                          ...
                          r.call(e, t).then(
                            function (t) {
                              s ||
                                ((s = !0), (o[u] = { status: 'fulfilled', value: t }), --a || n(o));
                            },
                            function (t) {
                              s ||
                                ((s = !0), (o[u] = { status: 'rejected', reason: t }), --a || n(o));
                            }
                          );
                      }),
                        --a || n(o);
