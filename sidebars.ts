    ...
    'books/index',
    {
      ...
      items: [
        ...
        },
        {
          ...
          label: '단위 테스트',
          items: [
            'books/unit-testing/introduction',
            'books/unit-testing/01',
            'books/unit-testing/02',
            'books/unit-testing/03',
            'books/unit-testing/04',
          ],
        },
      ],
    },
      ...
      items: [
        ...
        },
        {
          ...
          items: [
            ...
            'books/zero-to-one/06',
            'books/zero-to-one/07',
        ...
        },
        {
          type: 'category',
          label: '디멘드',
          items: ['books/demand/index', 'books/demand/intro', 'books/demand/01', 'books/demand/02', 'books/demand/03'],
        },
      ],
    },
    {
      ...
      items: [
        {
          type: 'category',
          label: '40일간의 산업일주',
          items: ['books/around-industries-in-40-days/introduction', 'books/around-industries-in-40-days/09'],
        },
        {
          type: 'category',
          label: '결제는 어떻게 세상을 바꾸는가',
          items: [
            'books/how-changing-the-way-we-pay-changes-everything/01',
            'books/how-changing-the-way-we-pay-changes-everything/02',
            'books/how-changing-the-way-we-pay-changes-everything/03',
            'books/how-changing-the-way-we-pay-changes-everything/04',
            'books/how-changing-the-way-we-pay-changes-everything/05',
            'books/how-changing-the-way-we-pay-changes-everything/06',
            'books/how-changing-the-way-we-pay-changes-everything/07',
            'books/how-changing-the-way-we-pay-changes-everything/08',
          ],
        },
      ],
    },
