...
- Versioning Labels - 버전을 계산하고 release를 생성하는 라벨들
  ...
  - `minor`: 버전의 두 번째 숫자 증가 `v_.1._`
  - `patch` `bug`: 버전의 세 번째 숫자 증가 `v_._.1`
...
![img](./images/auto-release-pipeline.png)
